...
//
//  Created by GrownYoda on 4/2/14.
...
@implementation InheritedMyScene
...
-(void) addBurst{
    ...
    emitterNode = [NSKeyedUnarchiver unarchiveObjectWithFile:[[NSBundle mainBundle]pathForResource:@"MyParticleFire" ofType:@"sks"]];
